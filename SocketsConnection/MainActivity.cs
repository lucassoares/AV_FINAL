...
namespace Sockets
{
    [Activity(Label = "Sockets", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        void SendInformationToServer(string stringToSend)
        {
            ...
            client.Connect("192.168.0.105/trabjamv/Usuario", 999);
        ...
        {
            int port = 999;
            IPAddress serverAddress = IPAddress.Parse("192.168.0.105/trabjamv/Usuario");
